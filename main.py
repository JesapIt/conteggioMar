...
,'Progetto interno', 'Formazione', 'Call con HR buddy', 'Case study', 'Organizzazione area', 'Altro', 'Task interno', 'Evento', 'Revisione Task', 'Creazione contenuti social', 'Video editing', 'Board Resp/Resp Vice', 'Business Game']
