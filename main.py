...
,'Progetto interno', 'Formazione', 'Call con HR buddy', 'Organizzazione area', 'Task interno', 'Evento', 'Revisione Task', 'Creazione contenuti social', 'Video editing', 'Interviste']
